<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\Program Files\WWW\system\public/../application/index\view\h5email\email\9\27.html";i:1506497455;}*/ ?>
...
<style type="text/css" media="screen">
	...
	* #Masthead {
		color: #fff;
		background: #963 url("img/bgMasthead.gif") no-repeat center 11px;
	}
	* #Masthead p {
		text-align: center;
		font-size: 14px;
...
<p><?php echo $data['content']; ?> </p>
				...
				<table id="Legal" cellspacing="0" cellpadding="15" width="505" style="color: #c2a385; background-color: #963;">
					<tr>
						<td style="color: #c2a385; font-family: Helvetica, Arial, sans-serif;">
