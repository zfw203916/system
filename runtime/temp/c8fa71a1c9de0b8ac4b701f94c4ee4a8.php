<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\hospital-tp5\public/../application/hospital\view\index\login.html";i:1503938781;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
      ...
      <div class="col-md-4 hui-margin-top-30 hui-padding-all-20 hui-background-color-white">
        ...
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h3 class="panel-title">账号密码：</h3>
          </div>
          <div class="panel-body">
            <ul class="list-group">
              <li class="list-group-item list-group-item-success"><?php echo $up['Uname']; ?></li>
              <li class="list-group-item list-group-item-info"><?php echo $up['Password']; ?></li>
